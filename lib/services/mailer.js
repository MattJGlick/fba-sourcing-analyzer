...
exports.mail = function(source, details) {
  ...
  if(details.money) {
    ...
    "<img alt='Embedded Image' height='128' width='128' src='https://dyn.keepa.com/pricehistory.png?asin=B001GZ6QEC&domain=com&width=800&height=250&amazon=1&new=1&used=1&salesrank=1&range=31&cBackground=000000&cFont=cdcdcd&cAmazon=ffba63&cNew=8888dd&cUsed=ffffff' />";
  } else {
